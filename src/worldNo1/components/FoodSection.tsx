      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
            “At Ramro Hostels, every meal carries the warmth of home — a
            comforting reminder of the love, care, and affection a mother puts
            into every plate for her children.”
          </p>
        </motion.div>
