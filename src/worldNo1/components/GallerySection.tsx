...
//         >
//           <p className="text-sm font-bold uppercase tracking-wide text-emerald-700">Photo Gallery</p>
//           <h2 className="mt-2 text-3xl md:text-5xl font-bold text-slate-950">A closer look at Ramro Hostel</h2>
//         </motion.div>
...
//                 <span className="inline-block px-3 py-1 bg-white/90 text-slate-950 text-xs font-bold rounded-full mb-2">{image.category}</span>
