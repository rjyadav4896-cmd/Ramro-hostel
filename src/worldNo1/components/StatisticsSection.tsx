        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {details.map((detail, index) => {
            ...
            return (
              ...
              >
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 text-emerald-700 transition duration-300 group-hover:bg-emerald-700 group-hover:text-white">
